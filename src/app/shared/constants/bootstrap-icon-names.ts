/** Every icon name shipped by the installed bootstrap-icons package (v1.13.1) - the `bi-` prefix
 *  is added by consumers, e.g. `bi-${name}`. Generated from node_modules/bootstrap-icons/font/bootstrap-icons.json;
 *  re-run that extraction if the bootstrap-icons dependency is upgraded. */
export const BOOTSTRAP_ICON_NAMES: readonly string[] = [
  '0-circle',
  '0-circle-fill',
  '0-square',
  '0-square-fill',
